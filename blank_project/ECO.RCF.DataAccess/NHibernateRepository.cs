...
using ECO.RCF.DataAccess.Helpers;
...
namespace ECO.RCF.DataAccess
{
    ...
    public class NHibernateRepository
    {
        ...
        /// </summary>
        /// <returns></returns>
        public IList<object> GetByCriteriaDistinct<T>(ICriteria criteria) where T : class
        {
        ...
        public IList<BaseEntity> GetByCriteriaDistinct(ICriteria criteria, string[] propiedades, Type tipoEntidad, bool distinct = false, IList<string> aliasesSearch = null)
        {
            //Lista de columnas o propiedades que queremos traer
            var projections = Projections.ProjectionList();

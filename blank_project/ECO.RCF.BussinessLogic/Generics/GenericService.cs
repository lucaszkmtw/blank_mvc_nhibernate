...
namespace ECO.RCF.BussinessLogic.Generics
{
    ...
    public class GenericService
    {
        ...
        protected GenericDataAccessService genericDataAccessService = GenericDataAccessService.GetInstance;
        ...
        protected object GetBySqlFunction(string sql, string parametro)
        {
            //Se consulta y se carga la respuesta, la cual es retornada en el metodo
            return genericDataAccessService.GetBySqlFunction(sql, parametro);
        }
        /// <summary>
        /// Devuelve un objeto Response con una lista de todos los objetos del tipo solicitado.
        /// </summary>
        ...
        protected IList<object> GetByCriteriaDistinct<T>(Search search, string [] propiedades, ISession session = null) where T : class
        {
            //Se consulta y se carga la respuesta, la cual es retornada en el metodo
            return genericDataAccessService.GetByCriteriaDistinct<T>(search,propiedades, session);
        }
        /// <summary>
